                ...
                <ul class="user-info pull-left">
                    <li class="profile-info dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#" aria-expanded="false"> <img
                                width="44" class="img-circle avatar" alt="" src="/back/images/admin.png">علی احمدی <span
                                class="caret"></span></a>
                        <!-- User action menu -->
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-md-3 animatedParent animateOnce z-index-50">
                            <div class="panel minimal panel-default animated fadeInUp">
                                <div class="panel-heading clearfix">
                                    <div class="panel-title">تعداد دانشگاه ها</div>
                                </div>
                                <div class="panel-body">
                                    <div class="row col-with-divider">
                                        <div class="col-xs-12 text-center stack-order">
                                            <h1 class="no-margins">{{$university}}</h1>
                                            <small>عدد</small>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3 animatedParent animateOnce z-index-49">
                            <div class="panel minimal panel-default animated fadeInUp">
                                <div class="panel-heading clearfix">
                                    <div class="panel-title">رشته های تحصیلی</div>
                                </div>
                                <div class="panel-body">
                                    <div class="row col-with-divider">
                                        <div class="col-xs-12 text-center stack-order">
                                            <h1 class="no-margins">{{$program}}</h1>
                                            <small>عدد</small>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3 animatedParent animateOnce z-index-48">
                            <div class="panel minimal panel-default animated fadeInUp">
                                <div class="panel-heading clearfix">
                                    <div class="panel-title">دروس</div>
                                </div>
                                <div class="panel-body">
                                    <div class="row col-with-divider">
                                        <div class="col-xs-12 text-center stack-order">
