                    ...
                    <div class="panel panel-default animated fadeInUp">
                        <div class="panel-body min-height-100">
                            <h1 class="page-title">
                                ...
                                ویرایش نوع دروس : {{$courseType->enname}}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group @if($errors->has('faname')) has-error @endif">
                                            <label>نوع درس (فارسی)<span class="text-danger">*</span></label>
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                                                <input type="text" class="form-control" name="faname" required
                                                       value="{{$courseType->faname}}">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group @if($errors->has('enname')) has-error @endif">
                                            <label>نوع درس (لاتین)<span class="text-danger">*</span></label>
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                                                <input type="text" class="form-control" name="enname" required
                                                       value="{{$courseType->enname}}">
                                            </div>
                                        </div>
