                    ...
                    <div class="panel panel-default animated fadeInUp">
                        <div class="panel-body min-height-100">
                            ...
                            <h1 class="page-title">
                                ...
                                لیست دسته بندی دروس
                                <a href="{{route('courseCategory.create')}}" class="btn btn-default btn-rounded pull-right"
                                   type="button">ثبت دسته بندی جدید </a>
                                <hr>
                            </h1>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-border table-hover" id="table_id">
                                        ...
                                        @foreach ($coursecategories as $coursecategory)
                                            <tr>
                                                <td class="text-center">{{$coursecategory->faname}}</td>
                                                <td class="text-center">{{$coursecategory->enname}}</td>
                                                <td class="text-center">
                                                    <form method="post"
                                                          action="{{route('courseCategory.destroy',$coursecategory->id)}}"
